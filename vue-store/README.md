...
> 这是本项目的前端，后端请移步到[store-server](https://github.com/hahahah/store-server) 。
...
**更新说明:** 项目源代码仓库在Github，此处会同步特定版本，想了解最新版本请移步[https://github.com/hahahah/vue-store](https://github.com/hahahah/vue-store)
...
后端采取了MVC模式，根据前端需要的数据分模块设计了相应的接口、控制层、数据持久层。后端传送地址[store-server](https://github.com/hahahah/store-server) 。
...
- 如果需要自己运行后端，请移步到[store-server](https://github.com/hahahah/store-server) clone后端项目，并修改前端的接口地址为您的服务器地址。

```
1. Clone project

git clone https://github.com/hahahah/vue-store.git
...
**作者** [hahahah](https://github.com/hahahah)
